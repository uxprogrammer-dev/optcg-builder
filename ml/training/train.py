...
def train(
    ...
    sequence_level_weight: float = 500.0,  # Phase 1: Weight for sequence-level loss (directly penalizes singleton-heavy generations) - Increased from 200.0 to 500.0 to very strongly penalize singleton-heavy decks
