...
def train(
    ...
    sequence_level_weight: float = 100.0,  # Phase 1: Weight for sequence-level loss (directly penalizes singleton-heavy generations) - Reduced from 500.0 to 100.0 to prevent training instability from quadratic penalties
